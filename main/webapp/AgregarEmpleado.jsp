...
<body class="bg-dark animate__animated animate__backInDown">
	<div class="container my-3 position-relative">
		...
		<p class="text-white text-center fs-1 fw-bolder">NUEVO EMPLEADO</p>
	</div>
	<br>
	<div class="container">
		<form action="ServletEmpleado">
			<table
				class="table table-responsive table-dark table-striped table-hover align-middle align-items-center">
				<thead>
				...
				<tbody class="text-center">
					<tr>
						...
						<td><input type="text" name="nom"
							class="form-control text-center bg-dark text-white border-4"></td>
					</tr>
					<tr>
						<td>APELLIDO</td>
